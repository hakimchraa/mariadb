...
VALUES ('2023',"La promo de l'année 2023",'2023-03-15',NULL) 
...
UPDATE tag
SET name = 'Terminal Bash' , description = 'Le HTML est un language de structuration de données.'
WHERE name = 'Bash'
...
DELETE FROM 'student'
WHERE ('first_name','last_name') LIKE ('Odette', 'Thomas')
WHERE 'first_name' = 'Odette' AND 'last_name' = 'Thomas'
